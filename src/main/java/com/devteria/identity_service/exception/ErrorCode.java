...
public enum ErrorCode {
    ...
    INVALID_PASSWORD(1005, "password must be at least {min} characters long", HttpStatus.BAD_REQUEST),
    ...
    INVALID_DOB(4000, "Your age must be at least {min} ", HttpStatus.BAD_REQUEST),
    ;
